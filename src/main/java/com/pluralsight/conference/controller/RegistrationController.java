...
public class RegistrationController {
    ...
    getRegistrations( ){
        ...
        return registrations;  // return type will return as json because of response-body annotation
    }
    ...
    getRegistrationReports( ){
        ...
        return registrationReports;  // return type will return as json because of response-body annotation
    }
    ...
    public @ResponseBody Registration updateRegistration(@Valid @ModelAttribute("registration")  Registration registration,
                                                         BindingResult result){
